 ...
 let getYTPVideoID = function (e) {
     ...
     return (
         e.indexOf("youtu.be") > 0 || e.indexOf("youtube.com/embed") > 0
             ? (r = (t = (r = e.substr(e.lastIndexOf("/") + 1, e.length)).indexOf("?list=") > 0 ? r.substr(r.lastIndexOf("="), r.length) : null) ? r.substr(0, r.lastIndexOf("?")) : r)
             : e.indexOf("http") > -1
             ? ((r = e.match(/[\\?&]v=([^&#]*)/)[1]), (t = e.indexOf("list=") > 0 ? e.match(/[\\?&]list=([^&#]*)/)[1] : null))
 ...
 !(function (jQuery, ytp) {
     (jQuery.mbYTPlayer = {
                             ...
                             (e.isBackground && ytp.backgroundIsInited) ||
                                 ...
                                 jQuery(e).on("YTPChanged", function (t) {
                                     ...
                                     new YT.Player(e.playerID, {
                                         ...
                                         events: {
                                             onReady: function (t) {
                                                 (e.player = t.target), e.player.loadVideoById({ videoId: e.videoID.toString(), suggestedQuality: e.opt.quality }), r.trigger("YTPlayerIsReady_" + e.id);
                                             },
         ...
         getDataFromAPI: function (e) {
             (e.videoData = jQuery.mbStorage.get("YTPlayer_data_" + e.videoID)),
                 e.videoData
                     ...
                     ? jQuery.getJSON("https://www.googleapis.com/youtube/v3/videos?id=" + e.videoID + "&key=" + jQuery.mbYTPlayer.apiKey + "&part=snippet", function (r) {
                           e.dataReceived = !0;
         ...
         toggleFilters: function (e) {
             let r = this.get(0);
             return r.isReady
                 ? (r.filtersEnabled ? (jQuery(r).trigger("YTPDisableFilters"), jQuery(r).YTPDisableFilters()) : (jQuery(r).YTPEnableFilters(), jQuery(r).trigger("YTPEnableFilters")), "function" == typeof e && e(r.filtersEnabled), this)
                 : this;
         },
                 ...
                 (YTPlayer.checkForStartAt = setInterval(function () {
                     ...
                     if (YTPlayer.player.getDuration() > 0 && YTPlayer.player.getCurrentTime() >= startAt && canPlayVideo) {
                         ...
                         if (
                             ...
                             YTPlayer.opt.mute
                                 ? $YTPlayer.YTPMute()
                                 : (YTPlayer.opt.autoPlay && (console.debug("To make the video 'auto-play' you must mute the audio according with the latest vendor policy"), YTPlayer.player.mute()), YTPlayer.player.unMute()),
                         ...
                         jQuery.extend(d, e),
                             ...
                             (i.timeout = setTimeout(function () {
                                 i.called || !o
                                     ...
                                     : (l.css(jQuery.CSS.sfx + "transition", ""), o.apply(i), (i.CSSAIsRunning = !1), "function" == typeof i.CSSqueue && (i.CSSqueue(), (i.CSSqueue = null)));
                             }, r + t + 10));
                     } else {
                         for (y in e)
