            ...
            (function () {
                ...
                function s(e) {
                    ...
                    e.parents(".cd-headline").hasClass("clip") &&
                        e.parents(".cd-words-wrapper").animate({ width: "2px" }, n, function () {
                            var i;
                            (i = t),
                                ...
                                (function (e, t) {
                                    e.parents(".cd-headline").hasClass("clip") &&
                                        e.parents(".cd-words-wrapper").animate({ width: e.width() + 10 }, n, function () {
                                            setTimeout(function () {
                                                s(e);
                                            }, o);
                                        });
            ...
            t("#contact .contact-section", function () {
                e("#contact .contact-section .contact-form").on("submit", function (t) {
                    ...
                    t.preventDefault(),
                        ...
                        setTimeout(function () {
                            e.ajax({ url: i.attr("action"), type: "POST", data: i.serialize() }).done(function (e) {
                                "success" == e
